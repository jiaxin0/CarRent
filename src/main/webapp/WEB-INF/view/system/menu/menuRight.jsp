...
<head>
	...
	<link rel="stylesheet" href="${car }/resource/css/public.css" media="all" />
	<link rel="stylesheet" href="${car }/resource/layui_ext/dtree/dtree.css">
	<link rel="stylesheet" href="${car }/resource/layui_ext/dtree/font/dtreefont.css">
...
<body class="childrenBody">
	...
	<script src="${car }/resource/layui/layui.js"></script>
	<script type="text/javascript">
	    var tableIns;
	    layui.extend({
			dtree:'${car}/resource/layui_ext/dist/dtree'
			...
			$("#doSearch").click(function(){
				...
				alert(params);
				tableIns.reload({
					url:"${car}/menu/loadAllMenu.action?"+params
				})
			});
		   ...
		   table.on('tool(menuTable)', function(obj){
			...
			function openUpdateMenu(data){
				mainIndex=layer.open({
					...
					success:function(index){
						...
						url="${car}/menu/updateMenu.action";
					}
				});
			}
			//保存
			...
			var menuTree = dtree.render({
		          ...
		          url: "${car}/menu/loadMenuManagerLeftTreeJson.action?spread=1",  // 使用url加载（可与data加载同时存在）
				  icon: "2",
				  accordion:true
				});
		...
		function reloadTable(id){
			tableIns.reload({
				url:"${car}/menu/loadAllMenu.action?id="+id
			})
		}
	</script>
</body>
